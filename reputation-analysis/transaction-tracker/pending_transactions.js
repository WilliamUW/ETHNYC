...
var safeOwner = '0xa5F623b3f1E0EEe821eED3D0A0e9C98e3f784284';
var ethAdapter = new protocol_kit_1.Web3Adapter({
    web3: web3,
    signerAddress: safeOwner
});
var readOnlyEthAdapter = new protocol_kit_1.Web3Adapter({ web3: web3 });
var safeService = new api_kit_1.default({
    txServiceUrl: 'https://safe-transaction-mainnet.safe.global',
    readOnlyEthAdapter: readOnlyEthAdapter
});
// get transaction
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var incomingTxs, multisigTxs, pendingTxs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, safeService.getIncomingTransactions(safeOwner)];
                case 1:
                    incomingTxs = _a.sent();
                    return [4 /*yield*/, safeService.getMultisigTransactions(safeOwner)];
                case 2:
                    multisigTxs = _a.sent();
                    return [4 /*yield*/, safeService.getPendingTransactions(safeOwner)];
                case 3:
                    pendingTxs = _a.sent();
                    return [2 /*return*/];
            }
